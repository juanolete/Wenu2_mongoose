...
const struct mgos_conf_entry mgos_config_schema_[264] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 263},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "wenu", .offset = offsetof(struct mgos_config, wenu), .num_desc = 2},
  {.type = CONF_TYPE_STRING, .key = "device", .offset = offsetof(struct mgos_config, wenu.device)},
  {.type = CONF_TYPE_STRING, .key = "id", .offset = offsetof(struct mgos_config, wenu.id)},
};
...
void mgos_config_set_wenu_device(struct mgos_config *cfg, const char *val) {
  mgos_conf_set_str(&cfg->wenu.device, val);
}
void mgos_config_set_wenu_id(struct mgos_config *cfg, const char *val) {
  mgos_conf_set_str(&cfg->wenu.id, val);
}
/* }}} */
