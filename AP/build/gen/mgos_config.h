 ...
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/fwbuild-volumes/2.4.2/apps/example-wifi-scan-js-master/esp8266/build_contexts/build_ctx_374855811/build/gen/ /mongoose-os/fw/src/mgos_debug_udp_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_mbedtls_config.yaml /mongoose-os/fw/src/mgos_sys_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_sys_config.yaml /fwbuild-volumes/2.4.2/apps/example-wifi-scan-js-master/esp8266/build_contexts/build_ctx_374855811/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_config_wenu *mgos_config_get_wenu(struct mgos_config *cfg);
const char *mgos_config_get_wenu_device(struct mgos_config *cfg);
const char *mgos_config_get_wenu_id(struct mgos_config *cfg);
...
void mgos_config_set_wenu_device(struct mgos_config *cfg, const char *val);
void mgos_config_set_wenu_id(struct mgos_config *cfg, const char *val);
/* }}} */
...
static inline const struct mgos_config_wenu *mgos_sys_config_get_wenu(void) { return mgos_config_get_wenu(&mgos_sys_config); }
static inline const char *mgos_sys_config_get_wenu_device(void) { return mgos_config_get_wenu_device(&mgos_sys_config); }
static inline const char *mgos_sys_config_get_wenu_id(void) { return mgos_config_get_wenu_id(&mgos_sys_config); }
...
static inline void mgos_sys_config_set_wenu_device(const char *val) { mgos_config_set_wenu_device(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_wenu_id(const char *val) { mgos_config_set_wenu_id(&mgos_sys_config, val); }
